...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <p><strong>Effective Date:</strong> [Insert Date]</p>
      <p>
        At [Plant Disease Classification Project Name], we value your privacy and are committed to protecting your personal information.
        This Privacy Policy explains how we collect, use, and disclose information when you use our services.
      </p>
      ...
      <ul>
        ...
        <li><strong>Images:</strong> Plant images you upload, used for plant disease species identification.</li>
      </ul>
