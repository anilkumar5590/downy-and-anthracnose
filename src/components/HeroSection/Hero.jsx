    ...
    <section className="hero">
      <div className="hero-overlay">
        <div className="hero-content">
          ...
          <p>Upload a clear image of a plant leaf to identify diseases like Anthracnose and Downy Mildew using AI-powered analysis.</p>
          <button className="hero-button" onClick={onUploadClick}>
            <FaCamera className="button-icon" /> Upload Leaf Image
          </button>
        </div>
      </div>
    </section>
